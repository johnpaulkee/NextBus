...
public class TranslinkService extends AbstractTranslinkService {
	 ...
	 */
	private final static String APIKEY = "aL6zl20IHshdYmd0SPZG";  // insert your Translink key here
    ...
    public void addWaitTimeEstimatesToStop(BusStop stop) throws TranslinkException {
		...
		uriBuilder.append("stops/" + stopNum + "/estimates?apikey=" 
				+ APIKEY + "&count=3&timeframe=120");
	...
	//http://api.translink.ca/rttiapi/v1/buses?apikey=[APIKey]&stopNo=53987
	@Override
    public void addBusLocationsForStop(BusStop stop)
		...
		StringBuilder uriBuilder = new StringBuilder(
				"//api.translink.ca/RTTIAPI/V1/");
		uriBuilder.append("buses?apikey=" + APIKEY + "&" + "stopNo=" + stopNum);
